...
"""
from event.models import EventParticipation


def handle_get_past_participations(user, participation_type):
    ...
    return [
        ...
        if user_past_participation.get_participation_type() == participation_type
    ]


def handle_get_ongoing_participations(user, participation_type):
    ...
    return [
        ...
        if user_ongoing_participation.get_participation_type() == participation_type
    ]


def handle_get_future_participations(user, participation_type):
    ...
    return [
        ...
        if user_future_participation.get_participation_type() == participation_type
    ]
